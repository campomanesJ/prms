    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="encoder_home.php" class="nav-link <?= ($current_page == 'encoder_home.php') ? 'active' : '' ?>">
                        <i class="fa-solid fa-house nav-icon"></i>
                        <p>Home</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="baptism.php" class="nav-link <?= ($current_page == 'baptism.php') ? 'active' : '' ?>">
                        <i class="fa-solid fa-baby"></i>
                        <p>Baptism</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="confirmation.php" class="nav-link <?= ($current_page == 'confirmation.php') ? 'active' : '' ?>">
                        <i class="fa-solid fa-square-check"></i>
                        <p>Confirmation</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="marriage.php" class="nav-link <?= ($current_page == 'marriage.php') ? 'active' : '' ?>">
                        <i class="fa-solid fa-heart"></i>
                        <p>Marriage</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="death.php" class="nav-link <?= ($current_page == 'death.php') ? 'active' : '' ?>">
