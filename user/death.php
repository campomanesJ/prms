...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO death_tbl 
        (firstname, middlename, lastname, suffix, book_no, page_no)
        VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $firstname, $middlename, $lastname, $suffix, $book_no, $page_no);
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header bg-warning text-black rounded-top-4">
                        <h4 class="mb-0 fw-bold">
                            <i class="bi bi-person-x-fill me-2"></i>Death Record Form
                        </h4>
                    </div>
